...
export const getRouterData = app => {
  const routerConfig = {
    "/": {
      component: dynamicWrapper(app, ["user/user", "user/login"], () =>
        import("../layouts/BasicLayout")
      )
    },
    "/system/auth": {
      component: dynamicWrapper(app, ["system/auth"], () =>
        import("../routes/System/auth")
      )
    },
    "/system/role": {
      component: dynamicWrapper(app, ["system/role", "system/auth"], () =>
        import("../routes/System/role")
      )
    },
    "/product/export":{
      component: dynamicWrapper(app, ['product/product'], () =>
      import("../routes/Product/export")
    )
    },
    "/product/import":{
      component: dynamicWrapper(app, ['product/product'], () =>
      import("../routes/Product/import")
    )
    },
    "/sale/daily-sales":{
      component: dynamicWrapper(app, ['product/product'], () =>
      import("../routes/Product/salelist")
    )
    },
    "/exception/404": {
